...
🤖 Generated by Tachikoma (implementer@2026-05-09)
EOF
)"
```

`Major-item: <id>` in the PR body is the Repository Correlation Receipt. The orchestrator reads it on `pull_request` webhooks.
