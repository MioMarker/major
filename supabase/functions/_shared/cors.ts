...
// from local dev (`http://localhost:3000`), and from Shells (which speak
...
export const corsHeaders = {
  ...
  "Access-Control-Allow-Headers":
    "Content-Type, Authorization, X-Major-Shell-Id, X-GitHub-Event, X-GitHub-Delivery, X-Hub-Signature-256",
};
